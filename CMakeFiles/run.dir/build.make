...
CMakeFiles/run.dir/src/sg90EventHandler.cpp.o: src/sg90EventHandler.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/pi/raspi_project_16/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Building CXX object CMakeFiles/run.dir/src/sg90EventHandler.cpp.o"
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/run.dir/src/sg90EventHandler.cpp.o -c /home/pi/raspi_project_16/src/sg90EventHandler.cpp
...
CMakeFiles/run.dir/src/sg90EventHandler.cpp.i: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/pi/raspi_project_16/src/sg90EventHandler.cpp > CMakeFiles/run.dir/src/sg90EventHandler.cpp.i
...
CMakeFiles/run.dir/src/sg90EventHandler.cpp.s: cmake_force
	...
	/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/pi/raspi_project_16/src/sg90EventHandler.cpp -o CMakeFiles/run.dir/src/sg90EventHandler.cpp.s
...
bin/run: CMakeFiles/run.dir/src/dispatchEventService.cpp.o
bin/run: CMakeFiles/run.dir/src/event.cpp.o
bin/run: CMakeFiles/run.dir/src/events_def.cpp.o
...
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_gapi.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_stitching.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_aruco.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_barcode.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_bgsegm.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_bioinspired.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_ccalib.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_dnn_objdetect.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_dnn_superres.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_dpm.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_face.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_freetype.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_fuzzy.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_hfs.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_img_hash.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_intensity_transform.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_line_descriptor.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_mcc.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_quality.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_rapid.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_reg.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_rgbd.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_saliency.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_stereo.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_structured_light.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_superres.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_surface_matching.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_tracking.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_videostab.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_wechat_qrcode.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_xfeatures2d.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_xobjdetect.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_xphoto.so.4.5.5
bin/run: /usr/local/lib/libwiringPi.so
bin/run: /usr/local/lib/libpigpio.so
bin/run: /usr/local/lib/libcpptimer.a
bin/run: /usr/local/lib/libws2811.a
bin/run: /usr/lib/arm-linux-gnueabihf/librt.so
bin/run: /usr/local/lib/arm-linux-gnueabihf/libglog.so
bin/run: /usr/lib/arm-linux-gnueabihf/libpthread.so
bin/run: /usr/lib/arm-linux-gnueabihf/libboost_filesystem.a
bin/run: /usr/lib/arm-linux-gnueabihf/libboost_system.a
bin/run: /usr/lib/arm-linux-gnueabihf/libboost_thread.a
bin/run: /usr/local/lib/libraspicam.so
bin/run: /usr/local/lib/libraspicam_cv.so
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_shape.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_highgui.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_datasets.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_plot.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_text.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_ml.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_phase_unwrapping.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_optflow.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_ximgproc.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_video.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_videoio.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_imgcodecs.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_objdetect.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_calib3d.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_dnn.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_features2d.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_flann.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_photo.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_imgproc.so.4.5.5
bin/run: /usr/local/lib/arm-linux-gnueabihf/libopencv_core.so.4.5.5
bin/run: /usr/lib/arm-linux-gnueabihf/libboost_atomic.a
bin/run: CMakeFiles/run.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/pi/raspi_project_16/CMakeFiles --progress-num=$(CMAKE_PROGRESS_10) "Linking CXX executable bin/run"
